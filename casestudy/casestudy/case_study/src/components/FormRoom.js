          ...
          <div className="col-md-8 border-right">
            <div className="p-3 py-5">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h2 className="text-right">Edit service (Room)</h2>
              </div>
              <div className="row mt-2">
                <div className="col-md-12"><label className="labels">Name Service</label><input type="text" className="form-control" placeholder /></div>
              </div>
              <div className="row mt-2">
                ...
                <div className="col-md-6 pb-2"><label className="labels">Area</label><input type="number" className="form-control" placeholder="m2" /></div>
                <div className="col-md-6 pb-2"><label className="labels">Price</label><input type="number" className="form-control" /></div>
                <div className="col-md-6 pb-2"><label className="labels">Accompanied service</label><input type="text" className="form-control" /></div>
              </div>
              ...
              <div className="mt-5 text-center"><button className="btn btn-primary profile-button" type="button">Submit</button></div>
            </div>
          </div>
