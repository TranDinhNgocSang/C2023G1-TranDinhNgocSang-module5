...
import {showListTypeRental,} from "../service/type-rental/typeRental";
          ...
          <div className="col-md-8 border-right">
            <div className="p-3 py-5">
              ...
              onSubmit={async (service) => {
                const typeRentalById = getListTypeRental(service.typeRental);
                const newService = {
                  ...service,
                  typeService: {
                    id: 2,
              ...
              <div className="row mt-2">
                <div className="col-md-12">
                  ...
                  <Field type="text" className="form-control" name="nameService" />
                  <p style={{ color: "red" }}><ErrorMessage name="nameService" /></p>
                </div>
              </div>
              <div className="row mt-2">
                <div className="col-md-6 pb-2">
                  <label className="labels">Maximum number of people</label>
                  <Field type="number" className="form-control" name="maxPeople" />
                  <p style={{ color: "red" }}><ErrorMessage name="maxPeople" /></p>
                </div>
                <div className="col-md-6 pb-2">
                ...
                <p style={{ color: "red" }}><ErrorMessage name="area" /></p>
                <div className="col-md-6 pb-2">
                ...
                <div className="col-md-6 pb-2">
                  ...
                  <Field type="text" className="form-control" name="Standard" />
                  <p style={{ color: "red" }}><ErrorMessage name="Standard" /></p>
                </div>
              </div>
              <div className="row mt-3">
                <div className="col-md-6">
                  <label className="labels">Number of floors</label>
                  <Field type="number" className="form-control" name="numberFloors"/>
                  <p style={{ color: "red" }}><ErrorMessage name="numberFloors" /></p>
                </div>
